  ...
  },
  {
    ...
    onEnter: function () {
      ...
      main.innerHTML = `
        ...
        <p>Опсание и правила игры в можите посотреть в википедии.</p>
        ...
        <p class="about">В режимах игры, в нижней части приложения, отображается: слева - панель управления игрой: кнопки "Play" и "Pause" для запуска и остановки игры, кнопки перехода по истории игры "вперед/назад" (рботают только в режиме "Pause"); в центре - "ползунок" регулировки скорости игры; справа - окно ввода для создания поля игры.</p>`;
      lifeGame.stop();
    },
    onLeave: function () {
      main.innerHTML = ``;
