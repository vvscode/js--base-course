...
function isPolindrom(textString) {
    ...
    textString = textString.toLowerCase().replace(/[^userForm-zA-Zа-яА-Я]/g, '');
...
function drawCalendar(year, month, htmlEl) {
    ...
    {
         // if Sunday then 0 will be transfer in changeDayNumberIfSunday function as userForm parameter
