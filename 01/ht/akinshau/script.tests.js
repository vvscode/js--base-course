...
describe('fizzBuzz', function() {
    it('функция', function() {
        return assert.isOk(typeof isPalindrom === 'function');
    });
...
describe('isPalindrom', function() {
    ...
    it('возвращает true/false', function() {
        return assert.isOk(typeof isPalindrom('') === 'boolean');
    });
    it('asd - не полиндром', function() {
        return assert.isOk(isPalindrom('asd') === false);
    });
    it('asdsa - полиндром', function() {
        return assert.isOk(isPalindrom('asdsa') === true);
    });
    it('"" - полиндром', function() {
        return assert.isOk(isPalindrom('') === true);
    });
    it('asdsb - не полиндром', function() {
        return assert.isOk(isPalindrom('asdsb') === false);
    });
});
