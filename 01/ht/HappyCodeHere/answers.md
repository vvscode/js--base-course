...
```javascript
let favoriteGroup = 'papa roach'; // :metal: :fire:
...
когда обработчик ставится на какого нибудь общего предка и получать информацию в `event.target`
