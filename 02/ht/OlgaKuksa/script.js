...
function u(){
  ...
  this.askName=function(){this.name=prompt("Как вас зовут?"); return this};
  this.askAge=function(){this.age=prompt("Сколько вам лет?"); return this};
  this.showAgeInConsole=function(){console.log("Вам "+this.age+" лет");return this;}
  this.showNameInConsole=function(){console.log("Ваше имя "+this.name);return this;}

}
//var u=new u();
//u.askName().askAge().showAgeInConsole().showNameInConsole();
...
/*
//works if toString is called at the end of each iteration
       var result =0;
