...
describe("curry", function() {
  var funcFirst = function(a, b) {
    return a + b;
  };
  var funcSecond = function(a, b, с) {
    return a + b + с;
  };
  var funcTheThird = function(a, b, с, d) {
    return a + b + с + d;
  };
  var funcFourth = function(a, b, с, d, e) {
    return a + b + с + d + e;
  };
  it("Принимает функцию с 2 аргументами, возвращает верный результат", function() {
    assert.isOk(curry(funcFirst)(1)(1) === 2);
  });
  it("Принимает функцию с 3 аргументами, возвращает верный результат", function() {
    assert.isOk(curry(funcSecond )(1)(1)(1) === 3);
  });
  it("Принимает функцию с 4 аргументами, возвращает верный результат", function() {
    assert.isOk(curry(funcTheThird )(1)(1)(1)(1) === 4);
  });
  it("Принимает функцию с 5 аргументами, возвращает верный результат", function() {
    assert.isOk(curry(funcFourth)(1)(1)(1)(1)(1) === 5);
  });
});
...
describe("getCounter", function() {
  var c = getCounter(5);
  it("верно принимает значение", function() {
    assert.isOk(c.log() === 5);
  });
 it("верно прибавляет", function() {
    c.add(4);
    assert.isOk(c.log() === 9);
  });
  it("верно перезагружает", function() {
    c.reset();
    assert.isOk(c.log() === 0);
  });
  it("верно прибавляет", function() {
