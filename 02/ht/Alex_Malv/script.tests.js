...
describe("Сurry", function() {
    ...
    it("функция с 5 параметрами возвращает верное значение", function() {
    ...
    it("функция с 3 параметрами возвращает верное значение", function() {
        assert.isOk(curry(target3)(5)(8)(5) === 18);
    });
    it("функция с 2 параметрами возвращает верное значение", function() {
        assert.isOk(curry(target2)(11)(2) === 13);
    });
});
