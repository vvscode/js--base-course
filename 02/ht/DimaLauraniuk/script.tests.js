...
describe("curry", function () {
  it("curry func sum with 4 args", function () {
    function target1(a, b, c, d) {
      return a + b + c + d
    };
    assert.isOk(curry(target1)(1)(2)(3)(4) === 10);
  });
  it("curry func multiplicating 2 args", function () {
    function target2(a, b) {
      return a * b
    };
    assert.isOk(curry(target2)(2)(3) === 6);
  });
  it("curry func sum with 2 args", function () {
    function target3(a, b) {
      return a + b
    };
    assert.isOk(curry(target3)(2)(3) === 5);
  });
});
