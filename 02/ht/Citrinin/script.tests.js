...
describe("curry", function() {
    ...
    it("С одним параметров возвращает функцию", function() {
        assert.isOk(typeof curry(target2) === "function");
    });
    it("Принимает функции с различным количеством аргументов", function() {
        assert.isOk(curry(target5)(1)(2)(3)(4)(5) === 15);
        assert.isOk(curry(target4)(1)(2)(3)(4) === 10);
        assert.isOk(curry(target3)(1)(2)(3) === 6);
        assert.isOk(curry(target2)(1)(2) === 3);
    });
    it("Правильно вычисляет сумму", function() {
        assert.isOk(curry(target5)(21)(2)(-30)(4.5)(5.5) === 3);
        assert.isOk(curry(target5)(0)(0)(-30)(5)(1) === -24);
        assert.isOk(curry(target4)(1)(12)(3.1)(4.2) === 20.3);
        assert.isOk(curry(target4)(10)(11)(42)(7) === 70);
        assert.isOk(curry(target3)(-100)(2)(73) === -25);
        assert.isOk(curry(target3)(565)(-10)(1) === 556);
        assert.isOk(curry(target2)(-11)(73) === 62);
        assert.isOk(curry(target2)(3)(0) === 3);
    });
});
...
describe("debounce", function() {
    ...
    it("Возвращает функцию", function() {
        assert.isOk(typeof debounce(alert, 10) === "function");
    });
    it("Проверка работы если вызовы функции перекрывают друг друга", function(done) {
        var f = function(a, arr) {
            arr.push(a);
        }
        var array = [];
        var fDebounce = debounce(f, 1000);
        setTimeout(function() { fDebounce(3, array) }, 100); // игнор 
        setTimeout(function() { fDebounce(4, array) }, 800); // игнор
        setTimeout(function() { fDebounce(5, array) }, 1600); // игнор
    ...
    it("Проверка работы если вызовы функции не перекрывают друг друга", function(done) {
        var f = function(a, arr) {
            arr.push(a);
        }
        var array = [];
        var fDebounce = debounce(f, 1000);
        setTimeout(function() { fDebounce(3, array) }, 0); // выполнится 
        setTimeout(function() { fDebounce(4, array) }, 1200); // выполнится
        setTimeout(function() { fDebounce(5, array) }, 2400); // выполнится
...
describe("throttle", function() {
    ...
    it("Возвращает функцию", function() {
        assert.isOk(typeof throttle(alert, 10) === "function");
    });
    it("Проверка работы если вызовы функции перекрывают друг друга", function(done) {
        var f = function(a, arr) {
            arr.push(a);
        ...
        var array = [];
        var fThrottle = throttle(f, 1000);
        setTimeout(function() { fThrottle(3, array) }, 100); // выполнится 
    ...
    it("Проверка работы если вызовы функции не перекрывают друг друга", function(done) {
        ...
        var fThrottle = throttle(f, 1000);
        setTimeout(function() { fThrottle(3, array) }, 100); // выполнится 
        setTimeout(function() { fThrottle(4, array) }, 1200); // выполнится
        setTimeout(function() { fThrottle(5, array) }, 2400); // выполнится
