...
describe("curry", function() {
    ...
    it("return correct value for target1", function() {
        return assert.equal(curry(target1)(1)(2)(3)(4), 10);
    });
    it("return correct value for target2", function() {
...
describe("debounce", function() {
  ...
  it("вызывает функцию не чаще чем раз в delay миллисекунд", function() {
    var log = "";
