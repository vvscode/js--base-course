...
describe('curry', function() {
 ...
 return a + b;
      ...
      function target3(a, b, c) {
          return a + b+c;
      }
      function target4(a, b, c, d) {
          return a + b + c + d;
      }
      function target5(a, b, c, d, e) {
          return a + b + c + d+ e;
      }
      assert.isOk(curry(target1)(1)(2)(3)(4)===10); // 10
      assert.isOk(curry(target2)(5)(8)===13); // 13
      assert.isOk(curry(target3)(5)(8)(2)===15);
      assert.isOk(curry(target4)(5)(8)(1)(3)===17);
      assert.isOk(curry(target5)(5)(8)(1)(3)(8)===25);
  });
    it('проверяет параметр', function() {
