...
/**
 * gets calendar state if there is such calendar on localStorage
 * @param {*} calendarObj 
 * if there is calendar with this ID in local storage
 * then copy all the values to calendarObj
 * if no - write calendar to localStorage
 */
