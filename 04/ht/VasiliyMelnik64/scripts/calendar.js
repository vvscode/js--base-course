...
Calendar.prototype = {
  ...
  * @param {number} year
  * @param {number} month
  * @param {Object} el - DOM-element/list of DOM-elements
  ...
  */
  drawCalendar: function (year, month, el) {
    ...
    */
    ...
    var table ='<table><tr><th colspan="7"><button id="leftButton" style="visibility:' + allowChangeValue +'">&#9664</button><button id="rightButton" style="visibility:'+ allowChangeValue +'">&#9654</button>' +'<span style="visibility:'+ showMonthValue +'">'+ base.getMonthes()[this.date[1]-1] + ' ' + this.date[0] + '</span>' + '</th></tr><tr><th>ПН</th><th>ВТ</th><th>СР</th><th>ЧТ</th> <th>ПТ</th><th>СБ</th><th>ВС</th> </tr><tr>';
    for (var i = 0; i < defineDayOfTheWeek(date); i++) {
      table += '<td><span class="corner"></span></td>';
    }
    while (date.getMonth() == month - 1) {
      table += '<td><span class="corner">' + date.getDate() + '</span><div class="cellContent"></div></td>';
  ...
  */
  changeValue: function (e) {
    ...
    storage.pushItem(cellContent.parentNode.firstElementChild.innerHTML, cellContent.lastElementChild.innerHTML, actions.calendar.date);
  }
};  