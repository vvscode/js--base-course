...
"@test"[
  "testing interaction between the form and the blocks with the object with the code and with the calendar"
] = {
  ...
  "2.Assert": function() {
    ok(
      ~document
        ...
        .innerHTML.indexOf("allowChange : true;")
    );
    ok(
      ~document
        .querySelector(".table")
        .firstElementChild.firstElementChild.firstElementChild.innerHTML.indexOf(
          "button"
        )
    );
    ok(
      document
        ...
        .getElementsByTagName("BUTTON".length === 2)
    );
  },
  ...
  "4.Assert": function() {
    ok(
      ~document
        .getElementsByTagName("pre")[0]
        .innerHTML.indexOf("showMonth : true;")
    );
    ok(
      ~document
        .querySelector(".table")
  ...
  "10.Assert": function() {
    ok(
      ~document.getElementsByTagName("select")[0].innerHTML.indexOf("January")
    );
  },
...
"@test"["testing process of adding notes in the localStorage"] = {
  ...
  "2.Assert": function() {
    ok(
      ~document
        .getElementsByTagName("pre")[0]
        .innerHTML.indexOf("allowAdd : true;")
    );
  },
  ...
  "4.Assert": function() {
    ok(
      ~document
        .getElementsByTagName("pre")[0]
        .innerHTML.indexOf("allowRemove : true;")
    );
  },
  ...
  "8.Assert": function() {
    ok(
      ~document.querySelector('td[data-test="1"]').innerHTML.indexOf("test_1")
    );
  },
  ...
  "10.Assert": function() {
    ok(
      getComputedStyle(document.querySelector(".modalWindow")).display ===
        "block"
    );
  },
